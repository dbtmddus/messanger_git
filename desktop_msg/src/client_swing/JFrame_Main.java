	...
	ActionListener action = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if(obj==b_friend){
				...
				try {
					fp = new JScrollPanel_friends_in_main(connected_socket, id_n, main_frame);	// 친구 목록 많을시 시간 걸림, 새로고침 키 추가 시 이 줄만 없애면 됨
				...
				try {
					cr = new JScrollPanel_chat_list_in_main(connected_socket, id_n, main_frame);	// 친구 목록 많을시 시간 걸림, 새로고침 키 추가 시 이 줄만 없애면 됨
